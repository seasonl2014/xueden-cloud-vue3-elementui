<template>
    <el-card shadow="never" class="cus-card homeBoxCard">
        <template #header>
            <span>{{t('page.home.hottagscard.card-title')}}</span>
        </template>
        ...
        >
            <el-table-column
              type="index"
              :label="t('page.home.hottagscard.card.table-column-number')"
              :index="indexMethod"
              width="80">
            </el-table-column>
            <el-table-column
              ...
              prop="name"
              :label="t('page.home.hottagscard.card.table-column-name')"
              >
            </el-table-column>
            <el-table-column
              show-overflow-tooltip
              prop="hit"
              width="100"
              :label="t('page.home.hottagscard.card.table-column-hit')"
              >
            </el-table-column>
